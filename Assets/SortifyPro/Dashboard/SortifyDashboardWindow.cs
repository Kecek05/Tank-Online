...
#pragma warning disable CS0414
        ...
        private bool _isSortifyCollectionsEnabled;
...
#pragma warning restore CS0414
        ...
        private void UpdateDefineSymbols()
        {
            ...
            foreach (var buildTargetGroup in targetGroups)
            {
                ...
                if (_isSortifyCollectionsEnabled)
                {
                    defineSymbols.Add("SORTIFY_COLLECTIONS");
                }
                else
                {
                    defineSymbols.Remove("SORTIFY_COLLECTIONS");
                }
...
#pragma warning restore CS0162
        ...
        private void DrawModulesContent()
        {
            ...
            GUILayout.Space(5);
            DrawToggle("Enable Sortify Collections", ref _isSortifyCollectionsEnabled,
                "Activates the Sortify Collections module, adding support for advanced data structures like SDictionary.");
        ...
        private void DrawSettingsContent()
        {
            ...
            GUILayout.Space(5);
            bool showIconsSection = SortifyUserDataManager.GetUserSetting("ShowIconsSection", true);
            DrawToggle("Show Icons Section", ref showIconsSection,
                "Enabling this setting will display the Icons section in the hierarchy, allowing you to assign custom icons to objects.");

            if (showIconsSection != SortifyUserDataManager.GetUserSetting("ShowIconsSection", true))
                SortifyUserDataManager.SaveUserSetting("ShowIconsSection", showIconsSection);
