...
namespace Sortify
{
    ...
    {
        private const float ExtraSpacingBelowHeader = 8f;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Rect propertyRect = new Rect(
                position.x,
                position.y + headerSize.y + EditorGUIUtility.standardVerticalSpacing + 1f + ExtraSpacingBelowHeader,
                position.width,
                position.height - headerSize.y - EditorGUIUtility.standardVerticalSpacing - ExtraSpacingBelowHeader
            );
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            float headerHeight = headerSize.y + EditorGUIUtility.standardVerticalSpacing + 1f + ExtraSpacingBelowHeader;
