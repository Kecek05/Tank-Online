...
namespace Sortify
{
    public static class SortifyDrawer
    {
        ...
        public static void Draw(int instanceID, Rect selectionRect, GameObject obj)
        {
            ...
            if(!string.IsNullOrEmpty(SortifyObjectManager.LoadCustomIcon(obj)))
                SortifyObjectManager.DrawCustomIcon(obj, selectionRect);
                ...
                for (int i = 0; i < components.Length; i++)
                {
                    ...
                    if (icon != null)
                    {
                        if (GUI.Button(buttonRect, icon, GUIStyle.none))
                        {
                            ...
                            SortifyComponentInspector.Show(components[i], rect);
                        }
